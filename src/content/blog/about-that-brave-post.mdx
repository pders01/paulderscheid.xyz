...
I should've made that clear but wasn't thinking about it when I wrote that post.

## Zen won

We now have a new browser that does all that was lined out in that post and more with [Zen](https://zen-browser.app/).
...
- [ ] Would really like my extension to be accessible from the omnibar (please don't make me use the mouse).
...
Still think that Arc did a lot for exploring new browser UX and I am thankful for that.
